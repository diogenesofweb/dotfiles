...
e = {"<cmd>Telescope file_browser path=%:p:h theme=dropdown previewer=false<cr>", "File Browser"},
b = {"<cmd>Telescope buffers theme=dropdown previewer=false<cr>", "List Buffers"},
